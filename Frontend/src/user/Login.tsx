            ...
            <div className="flex flex-col justify-center items-center flex-1">
                <div className="flex flex-col gap-4 bg-[#C52233] px-8 py-8 md:px-10 md:rounded-xl w-full max-w-md shadow-lg mx-4">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="text-white text-md font-light border border-white rounded-lg px-4 py-3 pr-12 bg-transparent placeholder-white w-full"
                            />
                            <button
                                type="button"
                                onClick={togglePasswordVisibility}
                                className="absolute right-3 top-1/2 transform -translate-y-1/2 text-white hover:text-gray-200 transition-colors cursor-pointer"
                    ...
                    <div className="flex flex-row items-center space-x-2">
                        <input type="checkbox" className=" border border-white w-5 h-5 checked:bg-white checked:border-white rounded-sm text-black" />
                        <label className="text-white text-sm font-light tracking-wide">Remember me</label>
                    </div>

                    {/* Sign In Button */}
                    <button onClick={() => navigate("/user/dashboard")} className="bg-white text-black border font-bold text-lg w-full py-3 rounded-lg mt-2 cursor-pointer hover:bg-gray-200 transition-colors">Sign In</button>
                </div>
            </div>
        </div>
    );
